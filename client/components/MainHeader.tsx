            ...
            <div className="upper">
                ...
                {!user.isLoggedIn ? (
                    <div onClick={() => setOpenLoginModal(true)}>
                        ...
                        <BiUserCircle
                            size={"32"}
                            color={`${router.route.split("/")[1] === "my" ? "#ff4b4b" : ""}`}
                        />{" "}
                    </div>
                ) : (
                    <div className="info-area" onClick={() => router.push("/my")}>
                        {" "}
                        {user.name.slice(0, 3)}님😁{" "}
                        <BiUserCircle size={"32"} color={`${router.route.split("/")[1] === "my" ? "#ff4b4b" : ""}`} />{" "}
                    </div>
                )}
            </div>
